...
--
-- Hôte : localhost:3306
-- Généré le :  Dim 03 juin 2018 à 15:46
...
--
-- Base de données :  `coinstrade_smartfolio`
--
...
(5, 'leton', 'cocoscorpio94@hotmail.fr', NULL, '$2y$10$X9aY5hEOBHN18aMdDxWC8udWopzC7W3z.6Dcj1qls9K387ll3Yn6q', 'manager', '$2y$10$xJIysUwpEkAe5GAoPeWmreYIJX9Jesrcg4U6OwB2Xh.eMgdYmYL0a', 1),
...
--
ALTER TABLE `port_accumulator`
  MODIFY `acc_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `transaction`
--
ALTER TABLE `transaction`
  MODIFY `tx_id` int(24) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
