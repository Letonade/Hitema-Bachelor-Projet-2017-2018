window.addEventListener("DOMContentLoaded", function () {
    var dim = {
            width: document.getElementById('chart').offsetWidth - 5,
            height: document.getElementById('chart').offsetHeight - 5,
            margin: {
                top: 20,
                right: 50,
                bottom: 30,
            ...
            ohlc: {
                height: document.getElementById('chart').offsetHeight - 195
            },
            indicator: {
                height: 65,
                padding: 5
        ...
        svg.append('text')
                .attr("class", "symbol")
                .attr("x", 20)
                .text(document.getElementById('chart').dataset.symbol);
        ...
        ohlcSelection.append("g")
            ...
            .append("text")
                ...
                .text("Price (" + document.getElementById('chart').dataset.index + ")");
        ...
        d3.csv("assets/scripts/chart.php?pair=" + document.getElementById('chart').dataset.pair, function(error, data) {
